 ...
 * <name>mapreduce.randomwriter.minkey</name> <value>10</value> </property>
 * <property> <name>mapreduce.randomwriter.maxkey</name> <value>10</value>
 * </property> <property> <name>mapreduce.randomwriter.minvalue</name>
 * <value>90</value> </property> <property>
 * <name>mapreduce.randomwriter.maxvalue</name> <value>90</value> </property>
...
public class RandomWriter extends Configured implements Tool {
	...
	static class RandomInputFormat extends InputFormat<Text, Text> {
		...
		public List<InputSplit> getSplits(JobContext job) throws IOException {
			...
			for (int i = 0; i < numSplits; ++i) {
				result.add(new FileSplit(new Path(outDir, "dummy-split-" + i),
						0, 1, (String[]) null));
			}
			return result;
		}
	...
	static class RandomMapper extends
