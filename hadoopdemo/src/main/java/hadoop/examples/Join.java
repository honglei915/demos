 ...
 * map. The example facilitates the same. To run: bin/hadoop jar
 * build/hadoop-examples.jar join [-r <i>reduces</i>] [-inFormat <i>input format
 * class</i>] [-outFormat <i>output format class</i>] [-outKey <i>output key
 * class</i>] [-outValue <i>output value class</i>] [-joinOp
 * &lt;inner|outer|override&gt;] [<i>in-dir</i>]* <i>in-dir</i> <i>out-dir</i>
 */
