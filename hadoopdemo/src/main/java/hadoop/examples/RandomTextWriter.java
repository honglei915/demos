 ...
 * <name>mapreduce.randomtextwriter.minwordskey</name> <value>5</value>
 * </property> <property> <name>mapreduce.randomtextwriter.maxwordskey</name>
 * <value>10</value> </property> <property>
 * <name>mapreduce.randomtextwriter.minwordsvalue</name> <value>20</value>
 * </property> <property> <name>mapreduce.randomtextwriter.maxwordsvalue</name>
...
public class RandomTextWriter extends Configured implements Tool {
		...
		public void map(Text key, Text value, Context context)
			...
			while (numBytesToWrite > 0) {
				...
				int noWordsKey = minWordsInKey
						+ (wordsInKeyRange != 0 ? random
								.nextInt(wordsInKeyRange) : 0);
				int noWordsValue = minWordsInValue
						+ (wordsInValueRange != 0 ? random
								.nextInt(wordsInValueRange) : 0);
				...
				numBytesToWrite -= (keyWords.getLength() + valueWords
						.getLength());
	...
	public int run(String[] args) throws Exception {
		...
		long totalBytesToWrite = conf.getLong(TOTAL_BYTES, numMapsPerHost
