...
/**
 * Montgomery method. References: [1] Richard Crandall and Carl Pomerance. Prime
 * Numbers: A Computational Perspective. Springer-Verlag, 2001. [2] Peter
 * Montgomery. Modular multiplication without trial division. Math. Comp.,
 * 44:519-521, 1985.
 */
class Montgomery {
	...
	class Product {
		...
		long m(final long c, final long d) {
			...
			final long a = LongLong.multiplication(xN_I, x.and(R_1), N_I).and(
					R_1);
