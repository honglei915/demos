...
public class ArithmeticProgression implements Comparable<ArithmeticProgression> {
		...
		if (this == obj)
			...
			if (this.symbol != that.symbol)
				throw new IllegalArgumentException(
						"this.symbol != that.symbol, this=" + this + ", that="
								+ that);
			return this.value == that.value && this.delta == that.delta
	...
	public int compareTo(ArithmeticProgression that) {
		...
		if (this.delta != that.delta)
			throw new IllegalArgumentException(
					"this.delta != that.delta, this=" + this + ", that=" + that);
	...
	public String toString() {
		return symbol + ":value=" + value + ",delta=" + delta + ",limit="
				+ limit;
	}
