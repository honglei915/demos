...
public class TeraChecksum extends Configured implements Tool {
	static class ChecksumMapper extends
			Mapper<Text, Text, NullWritable, Unsigned16> {
	...
	static class ChecksumReducer extends
			Reducer<NullWritable, Unsigned16, NullWritable, Unsigned16> {
