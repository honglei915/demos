package com.leiui.niodemo.http;
...
public class Request {
    ...
    /*
     * 设定用于解析HTTP请求的字符串匹配模式。对于以下形式的HTTP请求： GET /dir/file HTTP/1.1 Host: hostname
     * 将被解析成: group[1] = "GET" group[2] = "/dir/file" group[3] = "1.1" group[4]
     * = "hostname"
     */
